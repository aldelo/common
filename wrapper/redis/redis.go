...
func (r *Redis) handleXInfoGroupsCmd(xinfoGroupsCmd *redis.XInfoGroupsCmd, errorTextPrefix ...string) (outputSlice []redis.XInfoGroups, notFound bool, err error) {
	prefix := ""
...
func (p *PIPELINE) Pipeline() (redis.Pipeliner, error) {
	// validate
	if p.core == nil {
...
func (p *PIPELINE) Pipelined(fn func(redis.Pipeliner) error) ([]redis.Cmder, error) {
	// validate
	if p.core == nil {
...
func (p *PIPELINE) TxPipeline() (redis.Pipeliner, error) {
	// validate
	if p.core == nil {
...
func (p *PIPELINE) TxPipelined(fn func(redis.Pipeliner) error) ([]redis.Cmder, error) {
	// validate
	if p.core == nil {
